...
class VersionSettings(object):
    ...
    def SVN_VERSION(self):
        ...
        try:
            ...
            with open(os.path.join(config_folder, 'eegdatastorage.version'), 'r') as version_file:
                return self.parse_svn_version(version_file.read())
        except Exception:
            pass

        raise ValueError('cannot determine EEG Data Storage revision number')
